...
public class SplashScreenFragment extends DialogFragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setStyle(STYLE_NO_TITLE, R.style.AppTheme_TransparentStatusBar);
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        GlideApp.with(v)
                .asGif()
                .centerCrop()
                .load(R.drawable.video_camera_loader)
                .into(ivLoading);
        return v;
    }
    ...
    public void dismissAllowingStateLoss() {
        new Handler().postDelayed(super::dismissAllowingStateLoss, 500);
    }
}